...
@synthesize sharedDelegate, activeServer;
...
-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:YES];
     self.activeServer.text = [sharedDelegate currentServer:@""];
}
- (void)viewDidUnload
{
    [super viewDidUnload];
...
-(void)parserDidEndDocument:(NSXMLParser *)parser{
    ...
    if ([signupResult isEqualToString:@"You have Signed Up Successfully."]) {
        [[NSUserDefaults standardUserDefaults] setObject: emailTextField.text forKey:@"previousLogin"];
