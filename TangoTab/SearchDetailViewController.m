...
-(void)parserDidEndDocument:(NSXMLParser *)parser{
    ...
    if ([dealStatus isEqualToString:@"You have successfully claimed this offer."]) {
        ...
        [tab setSelectedIndex: 0]; // switch to myOffers
...
//{
//    FaceBook *obj = [FaceBook sharedDataSource];
//    PostFacebookViewController *postViewCtrl = [[PostFacebookViewController alloc]initWithNibName:@"PostFacebookViewController" bundle:[NSBundle mainBundle]];
//    postViewCtrl.fbGraph = obj.fbGraph;
//    [self.navigationController pushViewController:postViewCtrl animated:YES];
//}
//
//-(void)tweetwitterviewcontrolle
//{
//    Twitter *obj1 = [Twitter sharedDataSource];
//    PostTwitterViewController *postTwitterViewCtrl = [[PostTwitterViewController alloc] initWithNibName:@"PostTwitterViewController" bundle:[NSBundle mainBundle]];
