...
@synthesize activityIndicator;//, loadingLabel;
...
- (id)initWithFrame:(CGRect)frame
{
	if (self = [super initWithFrame:frame])
	{
		...
		//TangoTabAppDelegate *app=(TangoTabAppDelegate*)[[UIApplication sharedApplication] delegate];
...
- (id)initCentered 
{
	...
	[self initWithFrame:indicatorViewRect];
	return self;
}
