...
-(void) getValuesFromLocation {
    ...
    @try {
        ...
        NSURL *url2 =[NSURL URLWithString:urlst];
        
        NSString *str = [NSString stringWithContentsOfURL:url2 encoding:NSUTF8StringEncoding error:nil];
        NSArray *comSapa = [str componentsSeparatedByString:@","];
    
        latandlng = [[NSString alloc] initWithFormat:@"%@,%@",[comSapa objectAtIndex:2],[comSapa objectAtIndex:3]];
...
-(void) getValuesFromServer {
    ...
    if ([currentAddressDict count] !=0) {
        ...
        if ([addressSearchBar.text length] == 0 ) {
            ...
            serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=0&noOfdeals=0&searchingradius=%@&coordinate=%@&userId=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,[sharedDelegate.searchingradies objectForKey:@"radies"],[addArray objectAtIndex:2],[sharedDelegate.userdetails  valueForKey:@"userId"]];
            ...
            serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=0&noOfdeals=0&searchingradius=%@&coordinate=%@&userId=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,[sharedDelegate.searchingradies objectForKey:@"radies"],latandlng,[sharedDelegate.userdetails  valueForKey:@"userId"]];
        ...
        if ([addressSearchBar.text length]==0 ) {
            serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=0&noOfdeals=0&searchingradius=%@&coordinate=&userId=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,[sharedDelegate.searchingradies objectForKey:@"radies"],[sharedDelegate.userdetails  valueForKey:@"userId"]];
        ...
        if ([searchArray count]!=noOfOffers) {
            ...
            if ([currentAddressDict count] !=0) {
                ...
                if ([restaurantSearchBar.text length] != 0   && [addressSearchBar.text length] == 0) {
                    ...
                    serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=%i&noOfdeals=0&searchingradius=%@&coordinate=%@&userId=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,pageIndex,[sharedDelegate.searchingradies objectForKey:@"radies"],[addArray objectAtIndex:2],[sharedDelegate.userdetails  valueForKey:@"userId"]];
                    ...
                    serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=%i&noOfdeals=0&searchingradius=%@&coordinate=%@&userId=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,pageIndex,[sharedDelegate.searchingradies objectForKey:@"radies"],latandlng,[sharedDelegate.userdetails  valueForKey:@"userId"]];
                ...
                if ([addressSearchBar.text length]==0 ) {
                    ...
                    serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=%i&noOfdeals=0&searchingradius=%@&coordinate=&userId=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,pageIndex,[sharedDelegate.searchingradies objectForKey:@"radies"],[sharedDelegate.userdetails  valueForKey:@"userId"]];
