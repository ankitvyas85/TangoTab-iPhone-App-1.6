...
@property(nonatomic,retain)NSMutableString *deal_name,*isconsumershownup,*host_manager_emailid,*deal_description,*deal_restrictions,*start_time,*end_time,*business_name,*reserved_time_stamp,*address,*image_url,*noOfdeals,*currentElement,*deal_id,*deal_manager_emailid,*con_res_id;
