...
-(void) getValuesFromServer {
    ...
    if ([currentAddressDict count] !=0) {
        ...
        if ([addressSearchBar.text length] == 0 ) {
            ...
            serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=0&noOfdeals=0&searchingradius=%@&coordinate=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,[sharedDelegate.searchingradies objectForKey:@"radies"],[addArray objectAtIndex:2]];
            ...
            serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=0&noOfdeals=0&searchingradius=%@&coordinate=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,[sharedDelegate.searchingradies objectForKey:@"radies"],latandlng];
        ...
        if ([addressSearchBar.text length]==0 ) {
            serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=0&noOfdeals=0&searchingradius=%@&coordinate=",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,[sharedDelegate.searchingradies objectForKey:@"radies"]];
        ...
        if ([searchArray count]!=noOfOffers) {
            ...
            if ([currentAddressDict count] !=0) {
                ...
                if ([restaurantSearchBar.text length] == 0 ) {
                    ...
                    serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=%i&noOfdeals=0&searchingradius=%@&coordinate=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,pageIndex,[sharedDelegate.searchingradies objectForKey:@"radies"],latandlng];
                    ...
                    serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=%i&noOfdeals=0&searchingradius=%@&coordinate=%@",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,pageIndex,[sharedDelegate.searchingradies objectForKey:@"radies"],[addArray objectAtIndex:2]];
                ...
                if ([addressSearchBar.text length]==0 ) {
                    ...
                    serverURL = [NSString stringWithFormat:@"%@/deals/search?restName=%@&address=%@&pageIndex=%i&noOfdeals=0&searchingradius=%@&coordinate=",SERVER_URL,restaurantSearchBar.text,addressSearchBar.text,pageIndex,[sharedDelegate.searchingradies objectForKey:@"radies"]];
